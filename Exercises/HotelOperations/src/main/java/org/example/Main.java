...
public class Main {
    public static void main(String[] args) {
        ...
        Hotel hotel = new Hotel("Caesar Hotel", "123 Wherever Street", "867-5379", hotelRooms);
        System.out.println("There are " + hotel.getAvailableRooms() + " room(s) available");
        System.out.println("There are " + hotel.getDirtyRooms() + " dirty room(s)");
    }
}